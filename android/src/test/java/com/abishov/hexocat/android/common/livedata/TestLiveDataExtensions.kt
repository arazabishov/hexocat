...
package com.abishov.hexocat.android.common.livedata
...
/**
 * Extension function to capture all values that are emitted to a LiveData<T>
 *   during the execution of `captureBlock`.
 *
